import { isAndroidTauriRuntime, writeToAndroidDownloads } from "@gestion-boutique/sync";
...
// le fichier nativement dans le dossier Téléchargements standard (voir
// packages/sync/nativeFolder.ts) plutôt que de compter sur le mécanisme de
// téléchargement du navigateur, qui ne fonctionne que sur les vraies
// plateformes navigateur (desktop, PWA) où il est resté inchangé.
